<?php
    // ===============你必须填写下面的必填参数才可以继续使用===============
    $_AFDIAN = array(
        'pageTitle' => 'lovecelebi', // 网页标题
        'userName'  => 'https://afdian.net/a/lovecelebi', // 你的用户名，即你的主页地址 @ 后面的那部分，如 https://afdian.net/@MisaLiu，那么 MisaLiu 就是你的用户名
        'userId'    => 'cc4b23d4344411ee95cb52540025c377', // 你的用户 ID，请前往 https://afdian.net/dashboard/dev 获取
        'token'     => 'dsqtefkyBapDn6NR8QWJx7vPY5jHTmuK'    // 你的 API Token，请前往 https://afdian.net/dashboard/dev 获取
    );
    // ===============你必须填写上面的必填参数才可以继续使用===============
